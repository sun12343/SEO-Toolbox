...
const Footer = () => {
  const links = [
    { title: "Product", items: ["Features", "Pricing", "Tools", "API"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <span className="text-lg font-bold dark:text-white">DocTools</span>
          </div>
        ...
        >
          <p>© {new Date().getFullYear()} DocTools. All rights reserved.</p>
          <div className="mt-4">
            <a
